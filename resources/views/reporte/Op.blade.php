@extends('layouts.app', ['page' => __('Reporte de Ordenes de Pedido Pendientes de FE'), 'pageSlug' => 'reportesop'])
@section('content')
<div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">   
                    <form method="post" action="{{ route('filtro.op') }}" autocomplete="off" id="filtro_factura">
                    @csrf
