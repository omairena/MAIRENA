...
<div class="container-fluid mt--7">
       ...
       id="input-num_id"
       pattern="[A-Za-z0-9]+"
       class="form-control form-control-alternative{{ $errors->has('num_id') ? ' is-invalid' : '' }}"
       placeholder="{{ __('Número de Identificación') }}"
       value="{{ $cliente->num_id }}"
       required>
...
<div class="form-group{{ $errors->has('codigo_actividad') ? ' has-danger' : '' }}">
  ...
  <input type="text" list="actividad-list" id="input-actividad" name="codigo_actividad" class="form-control form-control-alternative" value="{{ $cliente->codigo_actividad }}" required>
