@extends('layouts.app', ['page' => __('Reporte de REA'), 'pageSlug' => 'reportesSales'])
@section('content')
<div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">   
                    <form method="post" action="{{ route('filtro.rea') }}" autocomplete="off" id="filtro_factura">
                    @csrf
                    ...
                    <P>Este Reporte genera en excel, las FEC emitidas por terceros a el contribuyente al que pertenece esta cuenta de Sistema.</P>
                </div>
            </div>
        </div>
</div>
