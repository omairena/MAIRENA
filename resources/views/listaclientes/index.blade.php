@extends('layouts.app', ['page' => __('Lista de Clientes'), 'pageSlug' => 'listacli'])
<head>
        ...
        <div class="col-md-12">
            <div class="card ">
                <div class="card-header">
                    <div class="row">
                        <div class="col-8">
                            <h4 class="card-title">{{ __('Listas de Precios Para Cliente') }}</h4>
                        </div>
                        <div class="col-4 text-right">
                            <a href="{{ route('listcliente.create', $idcliente) }}" class="btn btn-sm btn-primary">{{ __('Crear Lista') }}</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
