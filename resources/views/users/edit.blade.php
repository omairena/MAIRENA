                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('user.update', $user) }}" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group{{ $errors->has('es_vendedor') ? ' has-danger' : '' }}">
                                    <label class="form-control-label" for="es_vendedor">{{ __('¿Es Vendedor?') }}</label>
                                    <select class="form-control form-control-alternative" id="es_vendedor" name="es_vendedor" value="{{ old('es_vendedor') }}" required>
                                        <option value="0" {{ ($user->es_vendedor == 0 ? 'selected="selected"' : '') }}>No</option>
                                        <option value="1" {{ ($user->es_vendedor == 1 ? 'selected="selected"' : '') }}>Si</option>
                                    </select>
