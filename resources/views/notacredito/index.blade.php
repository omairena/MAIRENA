@extends('layouts.app', ['page' => __('Notas de Crédito del Sistema'), 'pageSlug' => 'notacreditoall'])
<head>
...
<div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="post" action="{{ route('filtro.notacredito') }}" autocomplete="off">
                    @csrf
                                ...
                                @foreach ($sales as $sale)
                                 	<?php
                                        ...
                                        if ($sale->condicion_venta === '01') {
                                         ...
                                         $referencia = App\Facelectron::where('idsales', $sale->referencia_sale)->get();
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            @if($referencia[0]->tipodoc=='04')
                                            Tikt {{ $referencia[0]->numdoc }}
                                             @endif
                                             @if($referencia[0]->tipodoc=='01')
                                            Fact {{ $referencia[0]->numdoc }}
                                             @endif
                                            </td>
                                        ...
                                        <td>
                                        	<div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                    ...
                                                    @endif
                                                    @else
                                                    <a href="{{ route('notacredito.edit',  $sale->idsale) }}" class="dropdown-item">{{ __('Editar Factura') }}</a>
                                                    @endif
