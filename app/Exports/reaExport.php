...
class reaExport implements FromArray,WithHeadings, ShouldAutoSize, WithEvents
{
    ...
    */
    public function headings(): array
    {
        return [
            ...
            'Detalle Mensaje', 
            'Número Documento Proveedor FEC',
            'Identificación Emisor FEC',
            'Nombre Emisor',    
    ...
    public function array(): array
    {
        ...
        $sales = DB::table('receptor_fec')->select('receptor_fec.*', 'configuracion.*')
        ->join('configuracion', 'receptor_fec.idconfigfact', '=', 'configuracion.idconfigfact')
        ->where([
                ['receptor_fec.fecha_xml_envio', '>=', $this->fecha_desde],
                ['receptor_fec.fecha_xml_envio', '<=', $this->fecha_hasta],
                ['receptor_fec.idconfigfact', '=', Auth::user()->idconfigfact],
        ...
        foreach ($sales as $sale) {
            ...
            switch ($sale->tipo_documento_recibido) {
                ...
                break;
                case '08':
                    $nombre_doc = 'Factura Electronica de Compra';
          ...
          $otros_cargos =$strDatas[$documento]['ResumenFactura']['TotalOtrosCargos'];
                        ...
                        if (isset($strDatas[$documento]['DetalleServicio']['LineaDetalle'][$i]['Impuesto'])) {
                            if (!isset($strDatas[$documento]['DetalleServicio']['LineaDetalle'][$i]['Impuesto']['Monto'])) {
                                ...
                                for ($im=0; $im < count($strDatas[$documento]['DetalleServicio']['LineaDetalle'][$i]['Impuesto']); $im++) { 
                                    ...
                                    if (isset($strDatas[$documento]['DetalleServicio']['LineaDetalle'][$i]['Impuesto'][$im]['CodigoTarifa'])) {
                                        switch ($strDatas[$documento]['DetalleServicio']['LineaDetalle'][$i]['Impuesto'][$im]['CodigoTarifa']) {
                                            case '01':
                                ...
                                if (isset($strDatas[$documento]['DetalleServicio']['LineaDetalle'][$i]['Impuesto']['CodigoTarifa'])) {
                                        switch ($strDatas[$documento]['DetalleServicio']['LineaDetalle'][$i]['Impuesto']['CodigoTarifa']) {
                                            case '01':
                                                $imp_0 += $strDatas[$documento]['DetalleServicio']['LineaDetalle'][$i]['SubTotal'];
                                            break;
                                            case '02':
                                        ...
                                        $imp_otros += $strDatas[$documento]['DetalleServicio']['LineaDetalle'][$i]['Impuesto'][$im]['Monto'];//se agrego [$im] 21-02-2024
                                }
                                
                            }
                           
                        }else{
                           // dd($strDatas[$documento]['Clave']);
                    ...
                    if (isset($strDatas[$documento]['DetalleServicio']['LineaDetalle']['Impuesto'])) {
                        ...
                        if (!isset($strDatas[$documento]['DetalleServicio']['LineaDetalle']['Impuesto']['Monto'])) {
                            ...
                            for ($im=0; $im < count($strDatas[$documento]['DetalleServicio']['LineaDetalle']['Impuesto']); $im++) { 
                                ...
                                if (isset($strDatas[$documento]['DetalleServicio']['LineaDetalle']['Impuesto'][$im]['CodigoTarifa'])) {

                                    switch ($strDatas[$documento]['DetalleServicio']['LineaDetalle']['Impuesto'][$im]['CodigoTarifa']) {
                                        case '01':
                            ...
                            if (isset($strDatas[$documento]['DetalleServicio']['LineaDetalle']['Impuesto']['CodigoTarifa'])) {

                                    switch ($strDatas[$documento]['DetalleServicio']['LineaDetalle']['Impuesto']['CodigoTarifa']) {
                                        case '01':
                                            $imp_0 +=  $strDatas[$documento]['DetalleServicio']['LineaDetalle']['SubTotal'] ;
                                        break;
                                        case '02':
            ...
            $datos = array(
                ...
                //'documento_proveedor' => $sale->consecutivo_doc_receptor,//$documento_proveedor,
                 'documento_proveedor' => $documento_proveedor,
                'cedula_emisor' => $id_recep,
                'nombre_emisor' => $n_recep,
                ...
                'total_otros' => $imp_otros,
                'otros_cargos'=> $otros_cargos,
                'total_recepcion' => $sale->total_comprobante,//$strDatas[$documento]['ResumenFactura']['TotalComprobante'],
                ...
                'Id_Receptor' =>$strDatas[$documento]['Emisor']['Identificacion']['Numero'],
                'Nombre_Receptor' =>$strDatas[$documento]['Emisor']['Nombre'],
                'Moneda' =>$moneda,
                'TC' =>$tc,
