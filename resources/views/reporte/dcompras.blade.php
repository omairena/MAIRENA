@extends('layouts.app', ['page' => __('Reporte de Compras'), 'pageSlug' => 'reportesDCompras'])
@section('content')
<div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">   
                    <form method="post" action="{{ route('filtro.dcompras') }}" autocomplete="off" id="filtro_factura">
                    @csrf
