@extends('layouts.app', ['page' => __('Notas de Débito del Sistema'), 'pageSlug' => 'notadebitoall'])
<head>
...
<div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="post" action="{{ route('filtro.notadebito') }}" autocomplete="off">
                    @csrf
            ...
            <div class="card ">
                <div class="card-header">
                    <div class="row">
                        <div class="col-8">
                            <h4 class="card-title">{{ __('Notas de Débito') }}</h4>
                        </div>
                        <div class="col-4 text-right">
                            <a href="{{ route('consultarnd.index') }}" class="btn btn-sm btn-primary">{{ __('Consultar Documentos') }}</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    ...
                    <div class="">
                        <table class="table tablesorter " id="ver_notad_datatable">
