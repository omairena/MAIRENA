@extends('layouts.app', ['page' => __('Tiquetes del Sistema'), 'pageSlug' => 'tiquetes'])
<head>
...
<div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="post" action="{{ route('filtro.tiquete') }}" autocomplete="off" id="filtro_factura">
                    @csrf
            ...
            <div class="card ">
                <div class="card-header">
                    <div class="row">
                        <div class="col-8">
                            <h4 class="card-title">{{ __('Tiquetes Construidos') }}</h4>
                        </div>
                        <div class="col-4 text-right">
                            <a href="{{ route('facturar.create') }}" class="btn btn-sm btn-primary">{{ __('Nuevo Tiquete') }}</a>
                            <a href="{{ route('consultartiq.index') }}" class="btn btn-sm btn-primary">{{ __('Consultar Documentos') }}</a>
                                        	...
                                        	<div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                    @if(count($valor))
                                                        ...
                                                        <a href="{{ url('notaCredito/create', ['idsales' => $sale->idsale]) }}" class="dropdown-item">{{ __('Generar Nota de Crédito') }}</a>
                                                        <a href="{{ url('notaDebito/create', ['idsales' => $sale->idsale]) }}" class="dropdown-item">{{ __('Generar Nota de Débito') }}</a>
                                                        <a class="dropdown-item" href="#" data-toggle="modal" data-target="#mensajeHacienda" data-id="{{ $sale->idsale }}" id="HaciendamodalTiq">{{ __('Mensaje Hacienda') }}</a>
                                                     ...
                                                     <a href="{{ url('convertir-fr', ['idsales' => $sale->idsale]) }}" class="dropdown-item">{{ __('Re-Facturar') }}</a>
                                                     @endif
