					...
					for ($impto=0; $impto < count($this->xmlCompleto['DetalleServicio'][$i]['Impuesto']); $impto++) {
						...
						if ($this->xmlCompleto['tipoDocumento'] != '09') {
							if ($this->xmlCompleto['DetalleServicio'][$i]['EsExoneracion'] === '01') {
								...
								if (isset($this->xmlCompleto['DetalleServicio'][$i]['Exoneracion']['Inciso']) &&
    $this->xmlCompleto['DetalleServicio'][$i]['Exoneracion']['Inciso'] !== '' &&
    $this->xmlCompleto['DetalleServicio'][$i]['Exoneracion']['Inciso'] !== null) {
    $exoneracion->appendChild($xmlDoc->createElement(
        "Inciso",
        $this->xmlCompleto['DetalleServicio'][$i]['Exoneracion']['Inciso']
    ));
}
