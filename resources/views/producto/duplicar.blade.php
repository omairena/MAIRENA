                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">{{ __('Duplicar Producto/Servicio') }}</h3><br>
                            </div>
                    ...
                    <div class="card-body">
                         <form method="post" action="{{ route('productos.store') }}" autocomplete="off" enctype="multipart/form-data">
                            ...
                            <h6 class="heading-small text-muted mb-4">{{ __('Duplicar Producto/Servicio') }}</h6>
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group{{ $errors->has('impuesto_iva') ? ' has-danger' : '' }}">
                                    ...
                                    <select class="form-control form-control-alternative" id="impuesto_iva" name="impuesto_iva" value="{{ old('impuesto_iva') }}" required>
                                        ...
                                        <option value="99" {{ ($producto->impuesto_iva == '99' ? 'selected="selected"' : '') }}>Tarifa No Sujeta</option>
                                    </select>
                                ...
                                <div class="form-group{{ $errors->has('codigo_cabys') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="codigo_cabys" id="input-codigo_cabys" class="form-control form-control-alternative{{ $errors->has('codigo_cabys') ? ' is-invalid' : '' }}" placeholder="{{ __('codigo_cabys') }}" value="{{ old('codigo_cabys', $producto->codigo_cabys) }}" required="false">
                                ...
                                <div class="form-group{{ $errors->has('flotante') ? ' has-danger' : '' }}">
                                    <label class="form-control-label" for="flotante">{{ __('¿Es Flotante?') }}</label>
                                ...
                                <div class="form-group{{ $errors->has('registro_medicamento') ? ' has-danger' : '' }}" id="combo_registro_sanitario" style="display: none;">
                                    ...
                                    <input type="text" name="forma_farmaceutica" id="forma_farmaceutica" class="form-control form-control-alternative{{ $errors->has('forma_farmaceutica') ? ' is-invalid' : '' }}" required>
...
<script type="text/javascript">
    $(document).ready(function() {
        if ($('#exportable').val() > 0) {
            ...
            $('#combo_arancelaria').prop("required", true);
        }else{
            $('#combo_arancelaria').css( "display", "none");
            $('#combo_arancelaria').prop("required", false);
        }
        ...
        $('#impuesto_iva').change(function() {
            switch($(this).val()){
                case '01':
                    $('#porcentaje_imp').val(0);
                break;
                case '02':
                    $('#porcentaje_imp').val(1);
                break;
                case '03':
                    $('#porcentaje_imp').val(2);
                break;
                case '04':
                    $('#porcentaje_imp').val(4);
                break;
                case '05':
                    $('#porcentaje_imp').val(0);
                break;
                ...
                break;
                case '07':
                    $('#porcentaje_imp').val(8);
                break;
                case '08':
                    $('#porcentaje_imp').val(13);
                break;
                case '09':
                    $('#porcentaje_imp').val(0.5);
                break;
                case '99':
                    $('#porcentaje_imp').val(0);
                break;
   ...
   $(document).ready(function() {  
    $('#registro_sanitario').change(function() {  
        if ($(this).val() > 0) { // Si se selecciona "Sí"  
            ...
            $('#combo_registro_sanitario input').val(''); // Limpiar el campo al ocultarlo  
            $('#combo_registro_sanitario input').removeClass('is-invalid'); // Remover clases de error  
        }  
    });  
    
    // Inicializa el estado correcto  
    $('#registro_sanitario').change(); // Llama al evento al cargar la página  
});  
