@extends('layouts.app', ['page' => __('Cuentas por Pagar'), 'pageSlug' => 'cxp'])
<head>
        ...
        <div class="col-md-12">
            ...
            <div class="card ">
                <div class="card-header">
                    <div class="row">
                        <div class="col-8">
                            <h4 class="card-title">{{ __('Cuentas por Pagar') }}</h4>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    ...
                    <div class="">
                        <table class="table tablesorter " id="ver_cxp_datatable">
                            ...
                            <tbody>
                                @foreach ($cxpagar as $cxp)
                                    <tr>
                                        <td class="text-right">{{ $cxp->idcxcobrar }}</td>
                                        <td>{{ $cxp->cxpagar_cli[0]->nombre }}</td>
                                        <td class="text-right">{{ $cxp->cantidad_dias }}</td>
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                    <a href="{{ route('cxpagar.show', ['idcxpagar' => $cxp->idcxpagar]) }}" class="dropdown-item">{{ __('Ver Cuenta') }}</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
