@extends('layouts.app', ['page' => __('Facturas Electronica de Extortación del Sistema'), 'pageSlug' => 'allfee'])
<head>
...
<div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="post" action="{{ route('filtro.fee') }}" autocomplete="off" id="filtro_fee">
                    @csrf
            ...
            <div class="card ">
                <div class="card-header">
                    <div class="row">
                        <div class="col-8">
                            <h4 class="card-title">{{ __('Facturas Electrónicas de Exportación Construidas') }}</h4>
                        </div>
                        <div class="col-4 text-right">
                            <a href="{{ route('fee.create') }}" class="btn btn-sm btn-primary">{{ __('Nueva FEE') }}</a>
                            <a href="{{ route('consultarfee.index') }}" class="btn btn-sm btn-primary">{{ __('Consultar Documentos') }}</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    ...
                    <div class="">
                        <table class="table tablesorter " id="ver_fee_datatable">
