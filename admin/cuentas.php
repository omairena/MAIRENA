...
<html lang="en">
	...
	<form role="form" method="post" action="cuentas.php" id="form">
	     <div class="row ">
       
          <label >Cuenta Principal:</label>
          
                                            
<input type="text" name="docemitidos"  class="form-control " value="0"/>
      </div>
  ...
  <a class="foot-menu-item mbr-fonts-style display-7" href="principal.php?clave=Oscar1987**">Salir</a>
 ...
 <table class="tbl" id="myTable">
	...
	if(empty($cuenta)){
	   $query=mysqli_query($con," SELECT * FROM configuracion ")or die(mysqli_error()); 
	    ...
	    $query=mysqli_query($con," SELECT * FROM configuracion where gnl='$cuenta' ")or die(mysqli_error());
	}
