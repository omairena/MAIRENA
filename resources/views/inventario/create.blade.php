                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('inventario.store') }}" autocomplete="off" enctype="multipart/form-data" id="form_inventario_new">
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group{{ $errors->has('condicion_movimiento') ? ' has-danger' : '' }}" id="combo_condicion_movimiento">
                                    <label class="form-control-label" for="input-condicion_movimiento">{{ __('Condición de Movimiento') }}</label>
        ...
        $('#tipo_movimiento').change(function() {
            if ($(this).val() > 1) {
                ...
                $('#Agregar_producto').css( "display","");
                 $('#combo_condicion_movimiento').css( "display","none");
