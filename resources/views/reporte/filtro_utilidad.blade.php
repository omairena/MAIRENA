@extends('layouts.app', ['page' => __('Calculo de Utilidad'), 'pageSlug' => 'reportesUtilidad'])
@section('content')
<div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">   
                    <form method="post" action="{{ route('filtro.utilidad') }}" autocomplete="off" id="filtro_factura">
                    @csrf
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-4">
                            <h4 class="card-title">{{ __('Calculo de Utilidad') }}</h4>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table" id="ver_facturas_datatable">
                            <thead class=" text-primary">
                                <th scope="col" width="30%" class="text-center">{{ __('Total Utilidad de Documentos') }}</th>
                                <th scope="col" width="30%" class="text-center">{{ __('Total Utilidad en Notas de Credito') }}</th>
                                <th scope="col" width="40%" class="text-center">{{ __('Total Global') }}</th>
                            </thead>
                            <tbody>
                                <tr>
                                    <td class="text-right">{{ $data['sumatoria_utilidad_factura']}} ₡</td>
                                    <td class="text-right">{{ $data['sumatoria_utilidad_nc']}} ₡</td>
