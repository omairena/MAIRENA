@extends('layouts.app', ['page' => __('Reporte de Regimen Simplificado'), 'pageSlug' => 'reportesRegimen'])
@section('content')
<div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">   
                    <form method="post" action="{{ route('filtro.regimenexcel') }}" autocomplete="off" id="filtro_factura">
                    @csrf
