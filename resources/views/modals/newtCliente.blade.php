<div class="modal fade" id="newUsuario" tabindex="-1" role="dialog" style="display: none;" aria-hidden="true">
  <div class="modal-dialog modal-lg-inventario" role="document">
    <div class="modal-content">
      <form method="post" action="{{ route('clientet.jsonstore') }}" autocomplete="off" enctype="multipart/form-data" id="form_new_cliente">
        @csrf
        <div class="modal-header">
          <h5 class="modal-title">Agregar Nuevo Cliente Factura Egresos</h5>
