...
class SalesExportcolon implements FromArray,WithHeadings, ShouldAutoSize, WithEvents
{
...
$medio_pago = implode(', ', $medio_pago);  
    ...
    'numero_documento' => strval($sale->numero_documento),  
    'fechahora' => $sale->fechahora,  
    'condicion_venta' => $condicion_venta,  
    'num_id_cliente' => strval($sale->num_id),  
    ...
    'p_credito' => strval($sale->p_credito),  
    'sucursal' => $sale->sucursal,  
    'codigo_actividad' => $sale->codigo_actividad,  
    'tipo_moneda' => $sale->tipo_moneda,  
    'tipo_cambio' => strval($sale->tipo_cambio),  
    'tiene_exoneracion' => $tiene_exoneracion,  
    'total_descuento' => strval($descuentousd + $descuento),  
    'total_exento' => strval($imp_0 + $imp_0usd),  
    'total_red_05' => strval($imp_05 + $imp_05usd),  
    'total_red_1' => strval($imp_2 + $imp_2usd),  
    'total_red_2' => strval($imp_3 + $imp_3usd),  
    'total_red_4' => strval($imp_4 + $imp_4usd),  
    'total_trans_0' => strval($imp_5 + $imp_5usd),  
    'total_trans_4' => strval($imp_6 + $imp_6usd),  
    'total_trans_8' => strval($imp_7 + $imp_7usd),  
    'total_gravado' => strval($imp_13 + $imp_13usd),  
    'total_no_sujeto' => strval($imp_99 + $imp_99usd),  
    'total_iva' => strval($total_impusd + $total_imp),  
    'total_otros_cargos' => strval($total_otros_cargosusd + $total_otros_cargos),  
    'total_iva_devuelto' => strval($total_iva_devusd + $total_iva_dev),  
    'total_comprobante' => strval($total_comprobanteusd + $total_comprobante),  
    'total_iva_exonerado' => strval($impx_0 + $impx_2 + $impx_3 + $impx_4 + $impx_5 + $impx_6 + $impx_7 + $impx_13 + $impx_99 + $impx_05 + $impx_0usd + $impx_2usd + $impx_3usd + $impx_4usd + $impx_5usd + $impx_6usd + $impx_7usd + $impx_13usd + $impx_99usd + $impx_05usd),  
