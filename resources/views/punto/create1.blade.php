                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                ...
                                <div class="form-group{{ $errors->has('exoneracion') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="exocli" id="exocli" class="form-control form-control-alternative{{ $errors->has('exocli') ? ' is-invalid' : '' }}" placeholder="{{ __('Número exocli') }}" value="{{ $contado[0]->exocli }}">
            ...
            if ($(this).val().length <= 0) {
                ...
                $.ajax({
                    ...
                    success:function(response){
                        ...
                        if (arreglo > 0) {
                            if (response['success'][0]['num_id'] != 100000000 && tipo_documento === '96') {
        ...
        success: function(response) {
            ...
            if (response['success'].length > 0) {
                if (response['success'][0]['num_id'] != 100000000 && tipo_documento === '04') {
                    ...
                    $('#cliente').val(response['success'][0]['idcliente']);
                    traerNumFactura(APP_URL, o2);
                } else if (response['success'][0]['num_id'] === 100000000 && tipo_documento === '01') {
                    alert('Seleccionar otro tipo de documento');
                    $('#tipo_documento').val('04');
