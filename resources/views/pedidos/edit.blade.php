...
<div class="container-fluid mt--7">
    <div class="row">
        <div class="col-md-12">
            <form method="post" action="{{ route('pedidos.update', $pedido->idpedido) }}" autocomplete="off" enctype="multipart/form-data" id="form_factura">
            @csrf
            @method('PUT')
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <div class="text-right">
                                ...
                                <input type="text" name="numero_documento" id="numero_documento" value="{{ old('numero_documento', $pedido->numero_documento) }}" hidden="true">
